...
class DatasetVisibilityKittiSingle(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 'sub_dir' keeps the sample keys identical to the Argoverse/ITRI mapping
        # datasets so mixed-dataset batches collate cleanly (train_save KITTI uses
        # the datasetType==0 path and ignores sub_dir).
